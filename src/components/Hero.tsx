...
import { ArrowRight, Users, Wifi, Star } from 'lucide-react'
        ...
        <div className="relative grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left relative z-10">
            <div className="inline-block mb-4 px-4 py-1 rounded-full bg-gradient-to-r from-orange-500/10 to-orange-600/10 border border-orange-200">
              <p className="text-orange-700 text-sm font-medium">Smart Hotel Solutions</p>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-orange-900 leading-tight">
              Maximizing Hotel Revenue by{' '}
              <span className="relative">
                <span className="relative z-10 text-orange-500">Connecting Guests</span>
          ...
          {/* Image Section */}
          <div className="relative lg:translate-x-12 px-4 sm:px-6 lg:px-0">
            {/* Decorative Elements */}
            ...
            {/* Main Image */}
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-orange-900/10 mx-auto sm:mx-0">
            ...
            <div className="absolute -bottom-8 -left-8 bg-white/80 backdrop-blur-md rounded-xl p-4 shadow-xl border border-orange-100 hover:-translate-y-1 transition-transform">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-orange-900 font-semibold text-lg">30% More Engagement</p>
                  <p className="text-orange-600 text-sm">Among hotel guests</p>
                </div>
              </div>
            </div>
          </div>
